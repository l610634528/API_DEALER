...
def send_email(report_file):
    ...
    msg['From'] = 'l610634528@163.com'
    msg['To'] = '610634528@qq.com'
    msg['Subject'] = Header(subject, 'utf-8')  # 从配置文件中读取

    att1 = MIMEText(open(report_file, 'rb').read(), 'base64', 'utf-8')  # 从配置文件中读取
    att1["Content-Type"] = 'application/octet-stream'
    att1["Content-Disposition"] = 'attachment; filename="Test_report.html"'#.format(report_file)  # 参数化一下report_file
    msg.attach(att1)
